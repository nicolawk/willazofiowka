        ...
        <footer className="footer-container">
            <div className="footer-content">
                ...
                <div className="footer-section links">
                    ...
                    <ul>
                        <li><a href="#">{t("footer.explore.book")}</a></li>
                        <li><a href="#">{t("footer.explore.locations")}</a></li>
                        <li><a href="tel:+48534778575">{t("footer.explore.contact")}</a></li>
                    </ul>
                </div>
                ...
                <div className="footer-section contact">
                    ...
                    <div className="contact-item">
                        ...
                        <span>
                            {t("footer.visit.addressLine1")}<br />
                    ...
                    <div className="contact-item">
                        ...
                        <a href="mailto:zakopanezofiowka@gmail.com">zakopanezofiowka@gmail.com</a>
                    </div>
                    ...
                    <div className="contact-item">
                        ...
                        <a href="https://www.instagram.com/willazofiowka/">@willazofiowka</a>
                    </div>
                </div>
            </div>
            ...
            <div className="footer-bottom">
                <p>
                    ...
                    <a href="https://www.instagram.com/nicolawojcikowska/">
